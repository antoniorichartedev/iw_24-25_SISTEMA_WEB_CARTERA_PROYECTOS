package proyectum.vistas.sobrenosotros;

import proyectum.security.RolRestrictions.RoleRestrictedView;
...
@AnonymousAllowed
public class SobreNosotrosView extends Composite<VerticalLayout> implements RoleRestrictedView {
