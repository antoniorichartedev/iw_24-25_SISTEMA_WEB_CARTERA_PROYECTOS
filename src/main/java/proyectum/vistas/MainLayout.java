package proyectum.vistas;

import proyectum.security.login.SecurityService;
import proyectum.data.Rol;
import proyectum.data.entidades.Usuario;
import proyectum.security.login.AuthenticatedUser;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        menuEntries.forEach(entry -> {
            Usuario user = maybeUser.orElse(null);

            if (entry.icon() != null || isAuthorized(user, entry)) {
